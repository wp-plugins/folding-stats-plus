  ...
  <form id="fold_form" name="form1" method="post" action="<?php echo $location ?>&amp;updated=true">
  	...
  	<fieldset class="options">
  		...
  		<table width="100%" cellpadding="5" class="editform">
			...
			<tr>
					<td><label for="fold_results_bold">Results in Bold?:</label></td>
					<td><input id="fold_results_bold" name="fold_results_bold" type="checkbox" value="<?php print get_option('fold_results_bold');?>" <?php if(get_option('fold_results_bold') == 'bold') {?> checked="checked" <?php } ?>/></td>
			</tr>
			<tr>
					<td><label for="fold_results_color">Results Color:</label></td>
					<td><input id="fold_results_color" name="fold_results_color" type="text" value="<?php print get_option('fold_results_color');?>" style="width: 60px;" /> Eg: <font style="color: #ff0000;">ff0000</font><font style="color: #00ff00;"> 00ff00 </font><font style="color: #c0c0c0;">c0c0c0</font></td>
			</tr>
			<tr>
					<td><label for="fold_rank">Show full rank:</label></td>
					<td><input id="fold_rank" name="fold_rank" type="checkbox" value="<?php print get_option('fold_rank');?>" <?php if(get_option('fold_rank') == 'full') {?> checked="checked" <?php } ?>/></td>			
			</tr>	
			<tr>
					<td><label for="fold_del">Delete cache?:</label></td>
